...
class MultiPolygonTest extends BaseTestCase
{
    ...
    public function testInvalidArgumentExceptionAtLeastOneEntry()
    {
        $this->assertException(
            ...
            'KsquaredCoding\LaravelMysqlSpatial\Types\MultiPolygon must contain at least 1 entry'
        );
    ...
    public function testInvalidArgumentExceptionNotArrayOfPolygon()
    {
        $this->assertException(
            InvalidArgumentException::class,
            'KsquaredCoding\LaravelMysqlSpatial\Types\MultiPolygon must be a collection of KsquaredCoding\LaravelMysqlSpatial\Types\Polygon'
        );
        $multipolygon = new MultiPolygon([
            $this->getPolygon1(),
            $this->getLineString1(),
