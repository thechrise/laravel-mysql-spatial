...
use KsquaredCoding\LaravelMysqlSpatial\Types\MultiLineString;
...
class MultiLineStringTest extends BaseTestCase
{
    ...
    public function testInvalidArgumentExceptionAtLeastOneEntry()
    {
        $this->assertException(
            ...
            'KsquaredCoding\LaravelMysqlSpatial\Types\MultiLineString must contain at least 1 entry'
        );
    ...
    public function testInvalidArgumentExceptionNotArrayOfLineString()
    {
        $this->assertException(
            InvalidArgumentException::class,
            'KsquaredCoding\LaravelMysqlSpatial\Types\MultiLineString must be a collection of KsquaredCoding\LaravelMysqlSpatial\Types\LineString'
        );
        $multilinestring = new MultiLineString([
