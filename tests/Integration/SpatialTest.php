...
use KsquaredCoding\LaravelMysqlSpatial\Types\GeometryCollection;
use KsquaredCoding\LaravelMysqlSpatial\Types\LineString;
use KsquaredCoding\LaravelMysqlSpatial\Types\MultiPoint;
use KsquaredCoding\LaravelMysqlSpatial\Types\MultiPolygon;
...
class SpatialTest extends IntegrationBaseTestCase
{
    ...
    public function testSpatialFieldsNotDefinedException()
    {
        ...
        $this->assertException(\KsquaredCoding\LaravelMysqlSpatial\Exceptions\SpatialFieldsNotDefinedException::class);
    ...
    public function testOrderBySpatialWithUnknownFunction()
    {
        ...
        $this->assertException(\KsquaredCoding\LaravelMysqlSpatial\Exceptions\UnknownSpatialFunctionException::class);
    ...
    //    $point = new Point(0, 0);
    //
    //    $linestring1 = \KsquaredCoding\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(1 1, 2 2)");
    //    $linestring2 = \KsquaredCoding\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(20 20, 24 24)");
    //    $linestring3 = \KsquaredCoding\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(0 10, 10 10)");
    //
