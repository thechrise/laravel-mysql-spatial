...
'providers' => [
   ...
   */
  KsquaredCoding\LaravelMysqlSpatial\SpatialServiceProvider::class,
],
```
...
Then edit the migration you just created by adding at least one spatial data field. For Laravel versions prior to 5.5, you can use the Blueprint provided by this package (KsquaredCoding\LaravelMysqlSpatial\Schema\Blueprint):
 ...
 * @property \KsquaredCoding\LaravelMysqlSpatial\Types\Polygon $area
 */
...
| KsquaredCoding\LaravelMysqlSpatial\Types                             | OpenGIS Class                                                |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
In order for your Eloquent Model to handle the Geometry classes, it must use the `KsquaredCoding\LaravelMysqlSpatial\Eloquent\SpatialTrait` trait and define a `protected` property `$spatialFields`  as an array of MySQL Spatial Data Type column names (example in [Quickstart](#user-content-create-a-model)).
...
For Laravel versions prior to 5.5, you can use the Blueprint provided with this package: `KsquaredCoding\LaravelMysqlSpatial\Schema\Blueprint`.
